  ...
  public Instances kNearestNeighbours(Instance target, int kNN) throws Exception {
    ...
    for(int i=0; i<m_Instances.numInstances(); i++) {
      ...
      if(firstkNN<kNN) {
        ...
        System.out.println(m_DistanceFunction.distance(target, m_Instances.instance(i)));
        System.out.println("m_Dist: "+m_DistanceFunction); 
        System.out.println(" target: " + target );
        System.out.println(" m_Instances: " + m_Instances.instance(i) );
        System.out.println(" temp: " + temp );
        System.out.println(" m_Stats: " + m_Stats);
